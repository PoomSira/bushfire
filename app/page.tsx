  ...
  return (
    <div className="bg-[#FFFBF2] mx-auto max-w-screen">
      ...
      <div className="relative py-8 flex flex-col items-center justify-center">
        <div className="absolute inset-0 bg-[url('/home-new.webp')] bg-cover bg-center brightness-[.3]"></div>
      ...
      >
        <div className="absolute inset-0 bg-[url('/journey.webp')] bg-cover bg-center brightness-[.3]"></div>
