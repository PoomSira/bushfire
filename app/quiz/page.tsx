    ...
    <SmoothScrollWrapper>
      <div className="bg-[#FFFBF2] mx-auto max-w-screen">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center p-4">
          {/* Background Image */}
          <div className="absolute inset-0 bg-[url('https://cdn.jsdelivr.net/gh/PoomSira/bushfire@main/public/instruction.webp')] bg-[#FFFBF2] opacity-10 bg-cover bg-center brightness-75"></div>
